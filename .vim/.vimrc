...
"    set smartindent
  ...
  " Tenter de rester toujours sur la mÍme colonne lors de changements de
  " lignes :
  set nostartofline 
...
"    :au BufAdd,BufNewFile * nested tab sball
    ...
    set showcmd
    " Indiquer le nombre de modification lorsqu'il y en a plus de 0 suite ‡
    " une commande
     set report=0
...
"    noremap \cr dWdWddpÄkudw..I-jEÄkDdw...i -j^dW$A ÄkrpBÄklÄkDJIcvs up ^
    let @r='dWdWddpÄkudwdwdwI-jEÄkDdwdwdwdwi -j^dW$A ÄkrpBÄklÄkDJIcvs up ^Äkd'

    " revert changes:
    let @e='^df/...ÄkdddÄkuEÄklDÄkd^dW.EÄklÄkrÄkDÄkrdW.^i-jWi-j^DÄkuPa Icvs up ÄkdddÄku^'
