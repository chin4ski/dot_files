...
nnoremap <silent>n :let v:errmsg=''<cr>:silent! norm! n<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>zvzz
"nnoremap <silent>N :let v:errmsg=''<cr>:silent! norm! N<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>
nnoremap <silent>N :let v:errmsg=''<cr>:silent! norm! N<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>zvzz
"davide
"Original:
...
"nnoremap <silent>* :let v:errmsg=''<cr>:silent! let @/='\<<C-R>=expand("<cword>")<CR>\>'<CR>:set hls<CR>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>
"davide
"nnoremap <silent># :let v:errmsg=''<cr>:silent! norm! #<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>
